...
def insert_seed_data(session):
    ...
    for order in range(3):
        ...
        for _ in range(4):
            ...
            question = Question(
                ...
                description="3. How many people could be facing “near-unlivable” heat in 50 years?",
            )
    ...
    for order in range(2):
        ...
        for _ in range(2):
            ...
            question = Question(
                id=question_id,
                question_group_id=question_group.id,
                description="Write a letter responding to Ms. Emily Parker. You should write at least 120 words. You are not allowed to include your name.",
            )
            question_group.questions.append(question)
    ...
    for order in range(2):
        question_group = QuestionGroup(
            id=uuid4(),
            description="""
                <b>Part 1: Social Interaction (3’)</b><br>Now, the test begins. Let’s talk about reading.<br>""",  # noqa
            resource=None,
            skill=Skill.WRITING,
            duration=60,
        )
